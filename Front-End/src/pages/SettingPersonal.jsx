...
import { Input } from '../component/FormElements';
              ...
              <form className='row justify-content-center flex-md-row flex-column-reverse'>
                <div className='col-md-5'>
                  ...
                  <div className='pb-4'>
                    ...
                    <ButtonGroup>
                      {radios
                        .filter((radio, idx) => [0, 1, 6].includes(idx))
                        .map((radio, idx) => (
                          <ToggleButton
                            key={idx}
                  ...
                  <div className='d-flex pb-4'>
                    <div className='mb-2 pe-5'>
                      ...
                      <br />
                      <Button type='dashed'>+新增交友目標</Button>
                    </div>
                    <div className='mb-2'>
                  ...
                  <div className='d-flex pb-4'>
                    <div className='mb-2 pe-5'>
                      ...
                      <br />
                      <Button type='dashed'>+新增興趣</Button>
                    </div>
                    <div className='mb-2'>

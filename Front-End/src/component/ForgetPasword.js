...
function ForgetPassword() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const response = await axios.post('/users/resetPassword', requestBody);
          ...
          >
            ...
            >
              ...
              <div className='mb-1'>
                ...
                <button
                    type='submit'
                    className='btn btn-primary py-3 px-7 rounded-2 d-flex align-items-center justify-content-center btn'
                    disabled={submitting}
                    
                    style={{ color: '#fff', width: '113px', height: '38px', margin:'0 70%' }}
                    onClick={handleSubmit(onSubmit)}
                  >
                    {submitting ? '正在發送...' : '發送驗證碼'}
                  </button>
